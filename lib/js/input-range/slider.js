...
let _autobindDecorator = require('autobind-decorator');

let _autobindDecorator2 = _interopRequireDefault(_autobindDecorator);

let _label = require('./label');

let _label2 = _interopRequireDefault(_label);
 ...
 * @ignore
 */
let Slider = (_class = (function (_React$Component) {
